...
Se $|a|<1$, il processo è stazionario e può essere scritto come ritorno verso una media
...
Il parametro $a$ controlla la persistenza.
...
Nel modello autoregressivo il valore dipende dai valori passati della serie. Nel modello a media mobile, invece, il valore dipende dagli shock passati.
...
Qui $\mathcal{F}_t$ rappresenta l'informazione disponibile fino al tempo $t$.
...
Quindi, se $\gamma>0$, shock negativi aumentano la volatilità futura più degli shock positivi della stessa ampiezza. Per garantire $\sigma_t^2\ge 0$ servono condizioni sui parametri, ad esempio
